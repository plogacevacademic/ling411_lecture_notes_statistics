...
knitr::kable(rbind(
              ...
              c( paste0(mammalian_sleep$name[2], " (animal 2)"), "$X_4$", paste0(mammalian_sleep$sleep_total_h[2], " hours")),
              c( paste0(mammalian_sleep$name[3], " (animal 3)"), "$X_4$", paste0(mammalian_sleep$sleep_total_h[3], " hours")),
