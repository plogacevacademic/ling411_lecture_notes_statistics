...
| recipient  | default word order? | probability |
|:-----------|:--------------------|:------------|
| animate    | $1$                 | $p_1$|
| animate    | $0$                 | $1-p_1$|
| inanimate  | $1$                 | $p_2$|
...
- The probability of the entire data set is $P(observation_1, observation_2, ..., observation_n|p_1, p_2) =$ $P(observation_1|p_1, p_2) \cdot P(observation_2|p_1, p_2)\cdot ... \cdot P(observation_n|p_1,p_2)$
- For now, we can use it to compute the probability of the observed data for a specific set of parameters ...
- And next week, we'll exploit this knowledge to figure out $p_1$ and $p_1$, or something equivalent ...
